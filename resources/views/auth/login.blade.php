    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route("login") }}" novalidate>
                ...
                @if(session("mensaje"))
                    <p class="bg-red-500 text-white my-2 rounded-lg p-2 text-center uppercase font-bold">{{ session("mensaje") }} </p>
                @endif
                ...
                <div class="mb-5 flex items-center gap-2">
                    ...
                    <label class="text-gray-500 text-sm items-center">Mantener mi Sesión Abierta</label>
                </div>
