...
@section("contenido")
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-6/12 p-5">
            <img src="{{ asset("img/register.webp")}}" alt="Imagen Registro">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{route("register")}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    />
                    @error("username")
                        <p class="bg-red-500 text-white my-2 rounded-lg p-2 text-center uppercase font-bold">{{ str_replace('username', 'usuario', $message) }} </p>
                    @enderror
                </div>
